    ...
    <div className='membersButtonsGroup'>
      <div>
        <NavButton
          ...
          to={toProgress}
          color='secondary'
          className='progressMemberButton'
      ...
      {isMentor(role) || (
        <div>
          <Button outline color='secondary' className='editMemberButton' id={userId} onClick={handleEdit}>
            Edit
          </Button>
          <Button outline color='danger' className='deleteMemberButton' id={userId} onClick={handleDelete}>
            Delete
          </Button>
        </div>
      )}
